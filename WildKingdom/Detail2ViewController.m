...
@interface Detail2ViewController ()  <UICollectionViewDataSource, UICollectionViewDelegate, UITabBarControllerDelegate>
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=30ea12d567ebaa5ab8f977f32c5940f5&format=json&nojsoncallback=1&per_page=10&tags=tiger"];
